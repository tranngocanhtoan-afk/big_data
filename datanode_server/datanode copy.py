...
UPLOAD_SERVER_PORT = 5000        # Adjust as needed
            ...
            if success:
                ...
                if result_path is not None:
                    ...
                    upload_success = upload_block_to_server(
                        ...
                        server_port=UPLOAD_SERVER_PORT,
                        file_base=file_base,
                        block_id=f'{block_id}_analysis.txt',
                    ...
                    if upload_success:
                        ...
                        os.remove(file_path) 
                        print(f"[DataNode] Task {block_id} was removed from task directory")
...
def start_task_listener_bg_enhanced(listen_host='0.0.0.0', listen_port=7500):
    """
